...
First use the train-set `./entailmentbank/data/hypotheses_train.json` obtain the top-N candidate facts generated by the Knowledge Selection based on Iterative Hybrid Encoding `./explanation_regeneration_experiment.py`. 

Then you can use the released `build_2th_cross-encoder_train_data.py` script and output the second round of fine tuning data `./entailmentbank/train/cross_train_2th.csv`.
