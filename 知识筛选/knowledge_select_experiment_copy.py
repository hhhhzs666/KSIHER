...
# embedding_cache_path='embeddings-size-11941-nli.pkl'
...
test_list=[[1, 24, 49], [2, 23, 48], [3, 22, 47], [4, 21, 46], [5, 20, 45], [6, 19, 44], [7, 18, 43], [8, 17, 42],
           [9, 16, 41], [10, 15, 40], [11, 14, 39], [12, 13, 38], [13, 12, 37], [14, 11, 36], [15, 10, 35], [16, 9, 34], 
           [17, 8, 33], [18, 7, 32], [19, 6, 31], [20, 5, 30], [21, 4, 29], [22, 3, 28], [23, 2, 27], [24, 1, 26], [25, 0, 25]]
...
for i in range(len(test_list)):
    ...
    pred_q = open("prediction-50-{}.txt".format(i+1), "w")
    # out_q = open("retireval-25-{}.txt".format(i+5), "w")
    out_q = open("retireval-50-{}.txt".format(i+1), "w")
    ...
    Iterations = p[0] # number of iterations
    ...
    with open("data/语料库/pre_test-50-{}.json".format(i+1),'w') as f:
